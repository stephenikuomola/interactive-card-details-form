...
})({"hoa7M":[function(require,module,exports) {
 ...
 */ class FormComponent {
    ...
    #number = /** @type {HTMLInputElement}*/ document.getElementById("card-number");
    #month = /** @type {HTMLInputElement}*/ document.getElementById("card-month");
    #year = /** @type {HTMLInputElement}*/ document.getElementById("card-year");
    #securityNumber = /** @type {HTMLInputElement}*/ document.getElementById("card-cvc");
    // Select the button element
    #submitBtn = /** @type {HTMLButtonElement}*/ document.querySelector(".btn-submit");
    // Select the loading spinner
    #loadingSpinner = /** @type {HTMLDivElement} */ document.querySelector(".loading-spinner");
    // Select the feedback message on form submission
    #feedback = /** @type {HTMLElement } */ document.querySelector(".interactive-card__info-feedback");
    /**
   ...
   */ #handleCardNumberInput(evtObj) {
        if (evtObj.target instanceof HTMLInputElement) {
            ...
            if (position !== length && (position !== length - 1 || isNaN(parseInt(cardNumberInput.value[position], 10)))) cardNumberInput.selectionEnd = position;
   ...
   */ #validateUserInput() {
        ...
        inputElements.forEach(function(inputElement) {
            if (inputElement instanceof HTMLInputElement) {
                ...
                if (inputElement.value.trim() === "" || inputElement.validity.valueMissing) {
                    ...
                    const userError = this.#generateError(inputElement, "Wrong Format, letters only", "error active");
                    userErrors.push(userError);
                } else if (inputElement.getAttribute("id") !== "card-name" && inputElement.validity.patternMismatch) {
                    const userError = this.#generateError(inputElement, "Wrong Format, numbers only", "error active");
                    userErrors.push(userError);
                } else {
        ...
        userErrors.forEach(function(userError) {
            if (!(userError.message === "" && userError.className === "error")) throw userErrors;
        });
    }
}
new FormComponent();

},{}]},["hoa7M","gbMuj"], "gbMuj", "parcelRequiree732")

//# sourceMappingURL=index.9bd7e52c.js.map
